  ...
  export default function App() {
    ...
    return (
      ...
      <div>
        {screen === 'login' && (
          <div className="min-h-screen flex flex-col" style={{ backgroundImage: "url('cozy_bluebackground.png')", backgroundSize: "100%" }}>
          <header className=" flex justify-between px-5">     
            <img src="tmlogo.png" alt="Logo task manager" className="h-16"/>   
          </header>   
          <main className=" w-full flex-grow">
              <div className=" justify-center flex py-8">
              <div className="w-4/12 border-4 border-customBlackBlue rounded-2xl bg-customWhite flex  justify-center">
                <div>
                  <h1 className="text-5xl text-customDarkBlue items-center flex flex-col pb-5 pt-10 font-medium font-brastika"> SING IN</h1>
          ...
          <div className="min-h-screen flex flex-col" style={{ backgroundImage: "url('cozy_bluebackground.png')", backgroundSize: "100%" }}>
            ...
            <main className=" w-full flex-grow">
              <div className=" justify-center flex py-8">
                <div className="w-4/12 border-4 border-customBlackBlue rounded-2xl bg-customWhite flex  justify-center">
                  <div>
                    <h1 className="text-5xl text-customDarkBlue items-center flex flex-col pb-5 pt-10 font-medium font-brastika"> SIGN UP</h1>
        ...
        {screen === 'Dashboard' && (
          <div className="min-h-screen flex  bg-custombgpink4">
            <div className=" flex-col w-2/12 flex-grow px-2 bg-customWhite ">
              <img src="tmlogo3.png" alt="Logo task manager" className="h-12"/> 
              <button className="flex mt-20 my-5 pl-2 pr-6  hover:bg-customWeakestBlue rounded-2xl items-center" onClick={() => sideBarOptions(1)}>
                <RxDashboard className="mr-1 text-customGrey"/>
                <h1 className="text-2xl font-thin text-customGrey"> Dashboard </h1>
              </button>
              <button className="flex  my-5 pl-2 pr-6  hover:bg-customWeakestBlue rounded-2xl items-center" onClick={() => sideBarOptions(2)}>
                <MdAddCircleOutline className="mr-1  text-customGrey" />
                <h1 className="text-customGrey font-thin text-2xl"> Criar Tarefa </h1>
              </button>           
              
            </div>
            <div className="w-full items-center justify-center " style={{ backgroundImage: "url('cozyBBGwithcloud.png')", backgroundSize: "100%" }}>
              <div className=" pt-16 flex items-center justify-center">
                <h1 className="font-brastika text-customWhite text-4xl">Minhas Tarefas</h1>           
              </div>
        ...
        {screen === 'CreateTask' && (
          <div className="min-h-screen flex  bg-custombgpink4">
            ...
            <div className="w-full items-center justify-center " style={{ backgroundImage: "url('cozyBBGwithcloud.png')", backgroundSize: "100%" }}>
              <div className=" pt-16 flex items-center justify-center">
                <h1 className="font-brastika text-customWhite text-4xl">Criar Tarefa</h1>           
              </div>
